  ...
  initialize: () => {
    ...
    if (getStorage(STORAGE_KEYS.BOOKINGS).length === 0) {
      ...
      const pendingBooking = {
        ...
        final_amount: 1406,
        block_hash: bHash2,
        metadata: JSON.stringify({ network: "Sepolia", priceEth: "0.001406" }),
      ...
      const inTransitBooking = {
        ...
        metadata: JSON.stringify({ network: "Sepolia", priceEth: "0.003650", txHash: "0xabc123def456" }),
      ...
      const pendingBlock = {
        ...
        event_data: JSON.stringify({ customer: 'Priya Sharma', eth_payment: true }),
