...
export const AuthProvider = ({ children }) => {
  ...
  const checkAppState = async () => {
    try {
      ...
      // Skip remote check for mock dev mode
      if (appParams.appId === 'test-app-id' || !appParams.appId) {
        setAppPublicSettings({ id: 'mock-app', public_settings: {} });
        setIsLoadingPublicSettings(false);
        setIsLoadingAuth(false);
        
        // Check if we previously "logged out" in this mock session
        if (localStorage.getItem('mock_logged_out') === 'true') {
  ...
  const logout = (shouldRedirect = true) => {
    ...
    // For mock dev mode, we need to persist the logged out state
    if (appParams.appId === 'test-app-id' || !appParams.appId) {
